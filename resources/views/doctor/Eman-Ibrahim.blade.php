        ...
        <div class="col-lg-12">
          ...
          <tbody>
              <tr>
                  <td>25.000</td>
                  <td>35.000</td>
                  <td>حشوة أسنان لبنيه</td>
              </tr>
              <tr>
                  <td>30.000</td>
                  <td>60.000</td>
                  <td>تنظيف لثه (كل جلسه)</td>
              </tr>
              <tr>
                  <td>400.000</td>
                  <td>800$</td>
                  <td>زرع- جاندني ددانات - سيستم ايطالي</td>
              </tr>
              <tr>
                  <td>350.000</td>
                  <td>550$</td>
                  <td> زرع- جاندني ددانات - سيستم كوري</td>
              </tr>
              <tr>
                  <td>15.000</td>
                  <td>25.000</td>
              ...
              <tr>
                  <td>25.000</td>
                  <td>50.000</td>
                  <td>قلع سن عقل عادي</td>
              </tr>
              <tr>
                  <td>30.000</td>
                  <td>50.000</td>
                  <td>حشوة دائمه 1 ملغ بلاتين</td>
              </tr>
              <tr>
                  <td>30.000</td>
                  <td>50.000</td>
                  <td>حشوة دائمه 1 ملغ سيراميك أماميه</td>
              </tr>
              <tr>
                  <td>40.000</td>
                  <td>60.000</td>
                  <td>حشوة دائمه 1 ملغ سيراميك خلفيه</td>
              </tr>
              <tr>
                  <td>80.000</td>
                  <td>120.000</td>
                  <td>حشوة جذر أسنان أماميه </td>
              </tr>
              <tr>
                  <td>90.000</td>
                  <td>150.000</td>
                  <td>حشوة جذر أسنان خلفيه</td>
              </tr>
              <tr>
                  <td>60.000</td>
                  <td>140$</td>
              ...
              <tr>
                  <td>450.000</td>
                  <td>650.000</td>
                  <td>طقم أسنان عادي</td>
              </tr>
              <tr>
                  <td>650.000</td>
                  <td>1000.000</td>
                  <td>طقم أسنان ايطالي </td>
              </tr> 
          </tbody>
      </table>
            ...
            <div class="item">
              <div class="content">
                <div class="left-content">
                  <p>
                  B.D.S. M.Sc. in Prosthodontics
                  </p>
                  <h4>ايمان ابراهيم محمد شريف</h4>
                  <!-- <span>07504426445</span> -->
                </div>
                <div class="image">
                  <!-- <img src="assets/images/author9.jpg" style="width:225px"> -->
                </div>
              </div>
            </div>
          </div>
