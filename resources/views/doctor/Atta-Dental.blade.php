    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 offset-lg-2 header-text">
          <h2><em>Atta Dental</em> Center</h2>
          ...
          <table class="table table-info text-center">
            ...
            <tbody>
                ...
                <tr>
                    <td>100.000</td>
                    <td>120.000</td>
                    <td>قلع سن العقل 1 قناة</td>
                </tr>
                <tr>
                    <td>120.000</td>
                    <td>140.000</td>
                    <td>قلع سن العقل 2 قناة</td>
                </tr>
                <tr>
                    <td>140.000</td>
                    <td>180.000</td>
                    <td>قلع سن العقل 3 قناة</td>
                </tr>
                <tr>
                    <td>200.000</td>
                    <td>160.000</td>
                    <td>قلع سن العقل 4 قناة</td>
                </tr>
                <tr>
                    <td>150.000</td>
                    <td>200.000</td>
